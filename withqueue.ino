...
//initialize 5 element array that stores the last five last_payload -> payload_id
/*
byte * last_payload_arr = (byte*)malloc(sizeof(byte) * 5);
int last_ind;
for (last_ind = 0; last_ind < 5; last_ind++) {
   last_payload_arr[last_ind] = 0;
}
*/
int last_ind = 0;
